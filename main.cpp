...
int main(int argc, char* argv[])
{
    ...
    if (arguments.is_standard_work)
        printf("This program solves a quadratic equation in valid\n");
    while (true && arguments.is_standard_work) {
        main_struct_coef.a = 0;
